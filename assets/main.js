...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image01', { style: 'zoom-out-image', speed: 625, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text04', { style: 'fade-up', speed: 625, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text07', { style: 'fade-in', speed: 500, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons02', { style: 'fade-up', speed: 500, intensity: 0, threshold: 3, delay: 500, stagger: 125, staggerSelector: ':scope > li', replay: false });
